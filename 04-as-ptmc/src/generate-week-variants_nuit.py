...
w4_text_file = join(variant_dir, "nuit-4-weeks.txt")
w4_all_text_file = join(variant_dir, "nuit-4-weeks-all-variants.txt")
w8_text_file = join(variant_dir, "nuit-8-weeks.txt")
w8_all_text_file = join(variant_dir, "nuit-8-weeks-all-variants.txt")
# w12_text_file = join(variant_dir, "nuit-12-weeks.txt")
# w12_all_text_file = join(variant_dir, "nuit-12-weeks-all-variants.txt")
w16_text_file = join(variant_dir, "nuit-16-weeks.txt")
w16_all_text_file = join(variant_dir, "nuit-16-weeks-all-variants.txt")
...
if __name__ == "__main__":
    ...
    if not isfile(w16_text_file):
        filter_all_impossible_16_weeks_variants()
    else:
